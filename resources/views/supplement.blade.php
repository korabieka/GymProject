		 ...
		 <div class="h_menu4"><!-- start h_menu4 -->
		   <a class="toggleMenu" href="#">Menu</a>
			 <ul class="nav">
			   ...
			   <li class="active"><a href="{{url('/supplements')}}">المكملات الغذائية</a></li>
...
@foreach($supplements as $supplement)
  ...
  <!-- Thumb -->
    <div class="thumbnail">
      <img src="{{$supplement->thumb}}">
      <div class="caption">
      <!-- Title -->
        <h3>{{$supplement->name}}</h3>
        <!-- Content -->
        <p>{{substr($supplement->description,20)}} ...</p>
        <p><a href='{{url("/supplements/$supplement->id")}}' class="btn btn-primary" role="button">اكمل الموضوع</a></p>
      </div>
    </div>
  </div>
@endforeach
