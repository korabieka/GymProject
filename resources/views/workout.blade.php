		 ...
		 <div class="h_menu4"><!-- start h_menu4 -->
		   <a class="toggleMenu" href="#">Menu</a>
			 <ul class="nav">
			   ...
			   <li><a href="{{url('/diet')}}">االتغذية السليمة</a></li>
...
@if(count($workouts) > 0)
	@foreach($workouts as $workout)
	  <div class="col-sm-3">
	    <div class="thumbnail">
	      <!-- Thumb -->
	      <img src="{{$workout->photo}}" alt="...">
	      <div class="caption">
	      <!-- Title -->
	        <h3>{{$workout->title}}</h3>
	      <!-- Content -->
	        <p>{{$workout->content}}</p>
	        <p><a href='{{url("/workout_details/$workout->id")}}' class="btn btn-primary" role="button">جدول التمرين</a></p>
	      </div>
	    </div>
	  </div>
	@endforeach
