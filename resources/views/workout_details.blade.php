...
<html>
<head>
	<title>BodyBuildingAcademy | التمارين </title>
...
<body>
		 ...
		 <div class="h_menu4"><!-- start h_menu4 -->
		   <a class="toggleMenu" href="#">Menu</a>
			 <ul class="nav">
			   ...
			   <li class="active"><a href="{{url('/workout')}}">التمارين</a></li>
    ...
    <div class="main">
        ...
        <div class="about_banner_wrap">
      	   <h1 class="m_11">المكملات الغذائية</h1>
      	</div>
...
<div align="center" style="margin-top: 50px;margin-left: 50px;">
	<table class="table-bordered">
		<tr>
			<th style="color: black; font-size: 20px;">
				المجموعات
			</th>
		...
		<tr>
			<td style="color: black;font-size: 20px;">{{$workout_detail->count}}<br><p>مجموعات {{$workout_detail->sets}}</p></td>
			<td style="color: black;font-size: 20px;">{{$workout_detail->name}}</td>
		</tr>
		@endforeach
	</table>
</div><br><br><br>
